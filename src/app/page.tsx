...
export default function Home() {
  ...
  const contextValue = useMemo(() => ({
    ...
    areas, setAreas,
    selectedDistrictName, setSelectedDistrictsName,
    ...
    selectedArea, setSelectedArea // Included missing state
  }), [transactions, isLoading, districts, graphCalculation, areas, streets, projects, flatTypes, months, properties, selectedDistrictName, selectedStreetName, selectedproject, selectedFlatType, selectedMonth, selectedProjectType, selectedArea, setProperties]);
